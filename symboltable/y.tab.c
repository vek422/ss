...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_SEMI_COLON = 4,                 /* SEMI_COLON  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "COMMA", "SEMI_COLON",
  "TYPE", "ID", "print", "$accept", "program", "statement", "identifier", YY_NULLPTR
};
...
#line 1150 "y.tab.c"
  ...
  case 4: /* program: program print  */
#line 38 "parser.y"
                        { printTable(); }
#line 1156 "y.tab.c"
    break;

  case 5: /* statement: TYPE identifier SEMI_COLON  */
#line 41 "parser.y"
                                       { addSymbols((yyvsp[-2].type),(yyvsp[-1].id)); }
#line 1162 "y.tab.c"
    break;
...
#line 1169 "y.tab.c"
  ...
  case 7: /* identifier: identifier COMMA identifier  */
#line 45 "parser.y"
                                         { (yyval.id) = strcat(strcat((yyvsp[-2].id),","),(yyvsp[0].id)); }
#line 1175 "y.tab.c"
    break;
